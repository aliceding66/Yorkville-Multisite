...
<div class="header">
    ...
    <div class="headerTopRightContent">
        For more Information call <span class="home tollFree"><label id="ctl00_ctl00_TopHeader_lblTollFree">1-866-838-6542</label></span>
        
        <span class="followUs">
            Follow us on:  
            <a id="ctl00_ctl00_TopHeader_twitterLink" href="https://twitter.com/#!/YorkvilleU" target="_blank" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/images/twitter.png" alt="Twitter" /></a>
            <a id="ctl00_ctl00_TopHeader_facebookLink" href="https://www.facebook.com/YorkvilleUniversity" target="_blank" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/images/facebook.png" alt="Facebook" /></a>
            <a id="ctl00_ctl00_TopHeader_googlePlusLink" rel="publisher" href="https://plus.google.com/103371777696708605338/posts" target="_blank" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/images/googleplus.png" alt="Google Plus" /></a>
            <a id="ctl00_ctl00_TopHeader_youtubeLink" href="http://www.youtube.com/user/YorkvilleUniversity" target="_blank" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/images/youtube.png" alt="Youtube" /></a>
        <a id="ctl00_ctl00_TopHeader_youtubeLink" href="http://linkd.in/1yNxnr7" target="_blank" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/images/ln.png" alt="Linkedin" /></a>
        </span>
        <br /><br />
 ...
 <a id="ctl00_ctl00_TopHeader_campusLink" href="http://campus.yorkvilleu.ca/login/index.php" target="_blank" rel="nofollow">Campus Login</a>
    ...
    <table class="MainCMSMenu" cellspacing="0" cellpadding="0" id="ctl00_ctl00_headerTopNavigation_menuElem" border="0" style="z-index:1000;">
		<tr>
            ...
            <td class=" <?php if($menuid == 'partner-schools' || $uri_first == 'partner-schools') {echo 'top';} ?> navigation internationalStudents" id="ctl00_ctl00_headerTopNavigation_menuElem-004" onclick="CSubmenuElem('<?php echo site_url(); ?>/partner-schools');"  onmouseover="document.getElementById('ctl00_ctl00_headerTopNavigation_menuElem-004-subMenu').style.display = 'block';"  onmouseout="document.getElementById('ctl00_ctl00_headerTopNavigation_menuElem-004-subMenu').style.display = 'none';"  style="cursor:pointer;"><a href="<?php echo site_url(); ?>/partner-schools" class="hiddenTopNavLink">Partner Schools</a></td>
