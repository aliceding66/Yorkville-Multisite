...
<ul class="sponsors">
    <li><img src="<?php echo get_template_directory_uri(); ?>/images/schools/yvu.jpg" alt="Yorkville University" /></li>
    <li><a Target="_blank" href="http://www.rccit.ca/" title="Yorkville University" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/images/schools/rccit.jpg" alt="RCC Institute of Technology" /></a></li>
    
    <li><a Target="_blank" href="http://www.torontofilmschool.ca" title="Toronto Film School" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/images/schools/tfc.jpg" alt="Toronto Film School" /></a></li>
...
<div class="footer">
    <ul class="quicklinks">
        ...
        $menu_program = array(
			...
			'depth'           => 0,
			'theme_location'  => 'footer-menu-program' , 'menu'=>'Programs'
...
<br />
                <a id="ctl00_ctl00_BottomFooter_lnkNewsEvents" class="title" href="<?php echo site_url(); ?>/news">NEWS</a>
...
<br />
    ...
    <ul class="copyrightPrivacy">
        <li class="copyright">
            &copy; 2003-2015 RCC Institute of Technology
