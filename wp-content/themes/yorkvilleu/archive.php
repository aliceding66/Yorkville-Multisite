...
<div class="CMSBreadCrumbs"><a href="<?php echo site_url(); ?>" title="HOME">HOME</a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="<?php echo site_url(); ?>/news/" class="navigation newsEvents">News  </a> &nbsp;/&nbsp; <a href="<?php echo site_url(); ?>/news/blog/" class="CMSBreadCrumbsLink">Blog</a> &nbsp;/&nbsp; <span class="CMSBreadCrumbsCurrentItem"><?php single_month_title(' ') ?></span>
</div>
...
<div class="twoColumn firstColumn">
    ...
    <div class="headerImageText programs">
	 ...
	 <?php if (have_posts() && in_category('6')) : while (have_posts()) : the_post(); ?>	
