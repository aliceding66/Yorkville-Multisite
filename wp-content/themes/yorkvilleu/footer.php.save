<div class="footerShareThisWrapper"><div class="footerShareThis"><span  class='st_sharethis_button' displayText='ShareThis'></span></div></div>
...
<div class="footer"><ul class="quicklinks"><li class="rightBorder"><a id="ctl00_ctl00_BottomFooter_lnkPrograms" class="title" href="<?php echo site_url(); ?>/programs/">PROGRAMS</a>
<?php  $menu_program = array( 'menu_class'=>'CMSListMenuUL', 'menu_id'=>'menuElem','depth' => 0,'theme_location' => 'footer-menu-program', 'menu'=>'Footer menu Program'); wp_nav_menu( $menu_program); ?>
</li><li class="rightBorder leftBorder"><a href="<?php echo site_url(); ?>/about/" class="title" title="About">ABOUT</a>           <?php  $menu_about = array(
			'menu_class'      =>'CMSListMenuUL',// change ul class
			'menu_id'         =>'menuElem',//change ul id
			'depth'           => 0,
			'walker'  => new ik_walker(),
			'theme_location'  => 'about-menu', 'menu'=>'About Menu' 
		);wp_nav_menu( $menu_about); ?></li>
<li class="rightBorder leftBorder"><a href="<?php echo site_url(); ?>/admissions/" class="title" title="Admissions">ADMISSIONS</a><?php  
        $menu_about = array(
			'menu_class'      =>'CMSListMenuUL',// change ul class
			'menu_id'         =>'menuElem',//change ul id
			'depth'           => 0,
		...
		);wp_nav_menu( $menu_about); ?><br />
<a id="ctl00_ctl00_BottomFooter_lnkNewsEvents" class="title" href="<?php echo site_url(); ?>/news/">NEWS</a></li><li class="leftBorder"><a href="<?php echo site_url(); ?>/resources/" class="title" title="Resources">RESOURCES</a><?php  
        $menu_about = array(
			'menu_class'      =>'CMSListMenuUL',// change ul class
			'menu_id'         =>'menuElem',//change ul id
			'depth'           => 0,
...
<a href="<?php echo site_url(); ?>/admissions/international-students/" class="title" title="International Students">INTERNATIONAL STUDENTS</a><br />
<a href="<?php echo site_url(); ?>/contact-us/" class="title" title="Contact Us">CONTACT US</a>
</li></ul><ul class="copyrightPrivacy"><li class="copyright">&copy; 2003-<?php echo date('Y'); ?> RCC Institute of Technology | Yorkville Education Company ULC operates as Yorkville University</li><li class="privacy">
