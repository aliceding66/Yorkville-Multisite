...
<div class="sitemapli">
	<ul class="CMSSiteMapList li_cont1" style="float: left; width: 400px; margin-left:10px">
    ...
    <ul class="CMSSiteMapList li_cont1" style="float: left; margin-left:50px">
    <li class="CMSSiteMapListItem"><a href="<?php echo site_url(); ?>/admissions/" title="Admissions" class="CMSSiteMapLink">Admissions</a>
			<?php  $defaults = array('menu_class' =>'CMSSiteMapList', 'container'=>' ', 'menu_id'=>' ', 'depth'=>0, 'theme_location'=>'admissions',
			'menu'=>'Admissions',); wp_nav_menu( $defaults); ?>
		</li>
  		<li class="CMSSiteMapListItem"><a href="<?php echo site_url(); ?>/news/blog/" title="Partner Schools" class="CMSSiteMapLink">Student Stories</a>
			
		</li>
        <li class="CMSSiteMapListItem"><a href="<?php echo site_url(); ?>/resources/" title="Resources" class="CMSSiteMapLink">Resources</a>
			<?php  $defaults = array('menu_class' =>'CMSSiteMapList', 'container'=>' ', 'menu_id'=>' ', 'depth'=>0, 'theme_location'=>'resources'
			,'menu'=>'Resources',); wp_nav_menu( $defaults); ?>
		</li>
    	<li class="CMSSiteMapListItem"><a href="<?php echo site_url(); ?>/news/" title="News" class="CMSSiteMapLink">News</a>
			<?php  $defaults = array('menu_class' =>'CMSSiteMapList', 'container'=>' ', 'menu_id'=>' ', 'depth'=>0, 'theme_location'=>'news'
			,'menu'=>'News',); wp_nav_menu( $defaults); ?>
		</li>
        <li class="CMSSiteMapListItem"><a href="<?php echo site_url(); ?>/contact-us/" title="Contact Us" class="CMSSiteMapLink">Contact Us</a>
			<?php  $defaults = array('menu_class' =>'CMSSiteMapList', 'container'=>' ', 'menu_id'=>' ', 'depth'=>0, 'theme_location'=>'contact-us'
			,'menu'=>'Contact Us',); wp_nav_menu( $defaults); ?>
		</li>
