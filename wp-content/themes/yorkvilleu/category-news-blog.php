...
<div class="listItem blogs">
	...
	<div class="itemDescription blogs" <?php if (has_post_thumbnail()){ ?> style="min-height:171px" <?php } ?>>
		...
		?>     
        <img id="ctl00_ctl00_mainContent_imgHeader_imgImage" src="<?php echo $url; ?>" style="max-width: 250px;  border-top:10px solid #FFF;border-right:10px solid #FFF;border-bottom:10px solid #FFF; float: left;" alt="<?php the_title(); ?>">
           <?php } ?>
	...
	<li class="postDate">Posted: <strong> <?php  $pfx_date = get_the_date( 'm/d/Y g:i:s A', $post->ID ); echo $pfx_date;   ?></strong></li>
