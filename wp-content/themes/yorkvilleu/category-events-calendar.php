...
<ul class="BlogPDateWhole" style="clear:both"> 
    <li class="post_date_calendar" ><?php $event_date = get_post_meta($post->ID, 'date_picker_event', true);  $newDate = date("d F Y h:i A", strtotime($event_date)); echo $newDate; ?> </li>
	<li class="post_name_calendar"> <?php the_title(); ?></li>
	<li class="readBlog"> <a href="<?php echo get_permalink(); ?>">RSVP</a></li>
</ul>
