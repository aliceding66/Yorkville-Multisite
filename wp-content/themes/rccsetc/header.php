...
<!-- BEGIN SCRIPTS -->
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/js/carouselSlider.js" type="text/javascript"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/js/skmmenu.js" type="text/javascript"></script>

	
    <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/fancybox/jquery.fancybox.pack.js?v=2.1.5"></script>
    <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/fancybox/helpers/jquery.fancybox-media.js?v=1.0.6"></script>
...
<!-- SHARE THIS CODE -->
     ...
     <script type="text/javascript">
        stLight.options({ publisher: '34719432-65fa-4a5c-9df1-aaf053ba9a04' });
     </script>
<!-- END SHARE THIS CODE -->
...
<script>
        //Simple code to create a list after the editable text content to link to indiviual galleries.
        jQuery(document).ready(function ($) {
            ...
            if ($('a[name]').length > 1) {
                $('a[name]').each(function () {
                    ...
                    galleryList = galleryList + '<li><a href=\"#' + name + '\">' + title + '</a></li>';
                });
            }
            galleryList = galleryList + '</ul>';

            $('div.galleryContent').after(galleryList);
...
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-SJ6M"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-SJ6M');</script>
...
<div class="header">
    <div class="mainLogo">
        <a href="<?php echo site_url(); ?>/" title="Home">
            <img src="<?php echo get_template_directory_uri(); ?>/images/mainlogo.jpg" alt="RCCSETC" />   
        </a>
    </div>
    <div class="headerTopRightContent">
        For more Information call <span class="home tollFree"><label id="ctl00_ctl00_TopHeader_lblTollFree">1-877-569-5611</label></span>
        
        <span class="followUs">
            Follow us on:  
            <a id="ctl00_ctl00_TopHeader_twitterLink" href="https://twitter.com/rccit" target="_blank" ><img src="<?php echo get_template_directory_uri(); ?>/images/twitter.png" alt="Twitter" /></a>
            <a id="ctl00_ctl00_TopHeader_facebookLink" href="https://www.facebook.com/RCCInstituteofTechnology" target="_blank" ><img src="<?php echo get_template_directory_uri(); ?>/images/facebook.png" alt="Facebook" /></a>
            <a id="ctl00_ctl00_TopHeader_googlePlusLink" rel="publisher" href="https://plus.google.com/103465037889300829262/posts" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/googleplus.png" alt="Google Plus" /></a>
            <a id="ctl00_ctl00_TopHeader_youtubeLink" href="http://www.youtube.com/rccit" target="_blank" ><img src="<?php echo get_template_directory_uri(); ?>/images/youtube.png" alt="Youtube" /></a>
        <a id="ctl00_ctl00_TopHeader_youtubeLink" href="http://linkd.in/1mCQvTD" target="_blank" ><img src="<?php echo get_template_directory_uri(); ?>/images/ln.png" alt="Linkedin" /></a>
        </span>
        <br /><br />

		<form role="search" method="get" id="searchform" class="searchform" action="<?php echo site_url(); ?>/search_gcse">

        <a href="http://bookstore.yorkvilleu.ca/index.asp" target="_blank" rel="nofollow">Book Store</a> | 

       
 <a id="ctl00_ctl00_TopHeader_campusLink" href="http://campus.yorkvilleu.ca/" target="_blank" rel="nofollow">Web Campus Sign In</a> |

 <a id="ctl00_ctl00_TopHeader_campusLink" href="http://china.rccit.ca/" target="_blank" rel="nofollow">Chinese</a>
        ...
        <div class="mainContent">            
            <div class="mainInner">
                ...
                <div id="ctl00_ctl00_headerTopNavigation_menuElem_table">
    ...
    <table class="MainCMSMenu" cellspacing="0" cellpadding="0" id="ctl00_ctl00_headerTopNavigation_menuElem" border="0" style="z-index:1000;">
		<tr>
            ...
            <td class=" <?php if($menuid == 'international-students' || $uri_first == 'international-students') {echo 'top';} ?> navigation internationalStudents" id="ctl00_ctl00_headerTopNavigation_menuElem-004" onclick="CSubmenuElem('<?php echo site_url(); ?>/international-students/');"  onmouseover="document.getElementById('ctl00_ctl00_headerTopNavigation_menuElem-004-subMenu').style.display = 'block';"  onmouseout="document.getElementById('ctl00_ctl00_headerTopNavigation_menuElem-004-subMenu').style.display = 'none';"  style="cursor:pointer;"><a href="<?php echo site_url(); ?>/international-students/" class="hiddenTopNavLink">International Students</a></td>
            <td class=" <?php if($menuid == 'resources' || $uri_first == 'resources') {echo 'top';} ?> navigation resources" id="ctl00_ctl00_headerTopNavigation_menuElem-005" onclick="CSubmenuElem('<?php echo site_url(); ?>/resources/');"  onmouseover="document.getElementById('ctl00_ctl00_headerTopNavigation_menuElem-005-subMenu').style.display = 'block';"  onmouseout="document.getElementById('ctl00_ctl00_headerTopNavigation_menuElem-005-subMenu').style.display = 'none';"  style="cursor:pointer;"><a href="<?php echo site_url(); ?>/resources/" class="hiddenTopNavLink">Resources</a></td>
            <td class=" <?php if($uri_first == 'News-Events' || $uri_first == 'news-events') {echo 'top';} ?> navigation newsEvents" id="ctl00_ctl00_headerTopNavigation_menuElem-006" onclick="CSubmenuElem('<?php echo site_url(); ?>/news-events/');"  onmouseover="document.getElementById('ctl00_ctl00_headerTopNavigation_menuElem-006-subMenu').style.display = 'block';"  onmouseout="document.getElementById('ctl00_ctl00_headerTopNavigation_menuElem-006-subMenu').style.display = 'none';"  style="cursor:pointer;"><a href="<?php echo site_url(); ?>/news-events/" class="hiddenTopNavLink">News & Events</a></td>
