<?php
/*
Template Name: Mobile only
*/
?>
<?php get_header(); header("HTTP/1.0 404 Not Found"); ?>
 <!-- BreadCrumbs menu --> 

<div class="CMSBreadCrumbs"><a href="<?php echo site_url(); ?>/" title="HOME">HOME</a>&nbsp;&nbsp;/&nbsp;&nbsp;
</div>
...
<p style="font-size: medium; height: 400px;">The page you are looking for might have been removed, had its name changed or is temporarily unavailable. Go to our <a href="<?php echo site_url(); ?>/">homepage</a> to navigate to where you would like to go.</p>
