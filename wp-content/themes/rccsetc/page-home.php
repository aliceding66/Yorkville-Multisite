<?php get_header(); ?>
    ...
    <div class="carousel home">
        ...
        <ul class="carouselList">            
            <?php 
  $postids = array();
  $my_query = new WP_Query('posts_per_page=10&cat=1&orderby=id&order=ASC');
...
<a class="carouselLink" href="<?php echo site_url(); ?><?php echo $slider_url; ?>" Title='<?php the_title(); ?>'/>
<?php echo $imgs ?>
</a>
</li>
<?php endwhile; ?>
    ...
    <div class="twoColumn firstColumn home">
        <div class="about home">
            ...
            <div class="aboutContent home">
               <?php $text = get_post_meta($post->ID, 'text', true);  echo $text ?>
<p><a title="About" class="aboutContent more" href="<?php echo site_url(); ?>/about/">MORE</a></p>
            </div>
            <div class="takeTour home">
                <a id="ctl00_ctl00_mainContent_lnkTakeaTour" title="Student Stories" href="<?php echo site_url(); ?>/news-events/blog/"><img src="<?php echo get_template_directory_uri(); ?>/images/takeatour.png" alt="Student Stories" title="Student Stories" /></a>
            </div>
        </div>
...
<p class="upcomingEvent home">
  <img src="<?php echo get_template_directory_uri(); ?>/images/list-style-arrow.png" alt=">>" />
    <a href="<?php if($event_url){echo $event_url;}else{ echo get_permalink();} ?>" target="_blank" title="<?php the_title(); ?>" ><?php the_title(); ?>
    <br />
    <?php $event_date = get_post_meta($post->ID, 'date_picker_event', true);  $newDate = date("d F Y h:i A", strtotime($event_date)); echo $event_date; ?>
    </a>
</p>
...
<?php wp_reset_query(); ?>
            ...
            <p class="viewCalendar home"><a href="<?php echo site_url(); ?>/news-events/events-calendar/" title="View Calendar">VIEW CALENDAR</a></p>

        </div>

        <div class="facebookFeed home">

            <p class="eventsFacebookTitle home">Student Stories</p>



            <?php 

			$args = array( 'posts_per_page' => 4, 'orderby'=> post_date, 'category' => 14 );
            ...
            <?php $home_feed = get_post_meta($post->ID, 'home_feed', true); if($home_feed == 'on' || $home_feed[0] == 'on'){ ?> 

           <p class="upcomingEvent home"><img src="<?php echo site_url(); ?>/wp-content/themes/rccsetc/images/list-style-arrow.png" alt=">>">
           ...
           <p class="viewCalendar home"><a href="<?php echo site_url(); ?>/news-events/blog/" title="View Calendar">VIEW BLOG</a></p>
