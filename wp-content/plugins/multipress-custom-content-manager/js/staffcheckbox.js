setInterval(function(){ 
     if (typeof document.getElementById("in-staff-101").checked === "undefined"){
		...
		if (document.getElementById("in-staff-101").checked) {
			else if ((typeof document.getElementById("in-staff-99").checked != "undefined") && (document.getElementById("in-staff-99").checked)){
				 document.getElementById("branddiv").style.display = "block";
				document.getElementById("jurisdictiondiv").style.display = "block";
				document.getElementById("deliverydiv").style.display = "block";
				document.getElementById("baseprogramdiv").style.display = "block";
			 }
			else if ((typeof document.getElementById("in-staff-103").checked != "undefined") && (document.getElementById("in-staff-103").checked)){
				 document.getElementById("branddiv").style.display = "block";
				document.getElementById("jurisdictiondiv").style.display = "block";
				document.getElementById("deliverydiv").style.display = "block";
				document.getElementById("baseprogramdiv").style.display = "block";
