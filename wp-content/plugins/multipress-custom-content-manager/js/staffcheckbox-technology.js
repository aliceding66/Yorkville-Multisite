setInterval(function(){ 
    if (typeof document.getElementById("in-staff-115").checked === "undefined"){
		...
		if (document.getElementById("in-staff-115").checked) {
			if ((typeof document.getElementById("in-staff-113").checked != "undefined") && (document.getElementById("in-staff-113").checked)){
				 document.getElementById("branddiv").style.display = "block";
				document.getElementById("jurisdictiondiv").style.display = "block";
				document.getElementById("deliverydiv").style.display = "block";
				document.getElementById("baseprogramdiv").style.display = "block";
			 }
			else if ((typeof document.getElementById("in-staff-117").checked != "undefined") && (document.getElementById("in-staff-117").checked)){
				 document.getElementById("branddiv").style.display = "block";
				document.getElementById("jurisdictiondiv").style.display = "block";
				document.getElementById("deliverydiv").style.display = "block";
				document.getElementById("baseprogramdiv").style.display = "block";
