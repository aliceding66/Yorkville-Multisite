setInterval(function(){ 
    if (typeof document.getElementById("in-staff-137").checked === "undefined"){
		...
		if (document.getElementById("in-staff-137").checked) {
			if ((typeof document.getElementById("in-staff-135").checked != "undefined") && (document.getElementById("in-staff-135").checked)){
				 document.getElementById("branddiv").style.display = "block";
				document.getElementById("jurisdictiondiv").style.display = "block";
				document.getElementById("deliverydiv").style.display = "block";
				document.getElementById("baseprogramdiv").style.display = "block";
			 }
			else if ((typeof document.getElementById("in-staff-139").checked != "undefined") && (document.getElementById("in-staff-139").checked)){
				 document.getElementById("branddiv").style.display = "block";
				document.getElementById("jurisdictiondiv").style.display = "block";
				document.getElementById("deliverydiv").style.display = "block";
				document.getElementById("baseprogramdiv").style.display = "block";
