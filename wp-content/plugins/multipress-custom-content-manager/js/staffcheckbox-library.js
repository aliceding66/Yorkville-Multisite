setInterval(function(){ 
    if (typeof document.getElementById("in-staff-107").checked === "undefined"){
		...
		if (document.getElementById("in-staff-107").checked) {
			if ((typeof document.getElementById("in-staff-105").checked != "undefined") && (document.getElementById("in-staff-105").checked)){
				 document.getElementById("branddiv").style.display = "block";
				document.getElementById("jurisdictiondiv").style.display = "block";
				document.getElementById("deliverydiv").style.display = "block";
				document.getElementById("baseprogramdiv").style.display = "block";
			 }
			else if ((typeof document.getElementById("in-staff-109").checked != "undefined") && (document.getElementById("in-staff-109").checked)){
				 document.getElementById("branddiv").style.display = "block";
				document.getElementById("jurisdictiondiv").style.display = "block";
				document.getElementById("deliverydiv").style.display = "block";
				document.getElementById("baseprogramdiv").style.display = "block";
