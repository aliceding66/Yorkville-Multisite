setInterval(function(){ 
    if (typeof document.getElementById("in-staff-161").checked === "undefined"){
		...
		if (document.getElementById("in-staff-161").checked) {
			if ((typeof document.getElementById("in-staff-159").checked != "undefined") && (document.getElementById("in-staff-159").checked)){
				 document.getElementById("branddiv").style.display = "block";
				document.getElementById("jurisdictiondiv").style.display = "block";
				document.getElementById("deliverydiv").style.display = "block";
				document.getElementById("baseprogramdiv").style.display = "block";
			 }
			else if ((typeof document.getElementById("in-staff-163").checked != "undefined") && (document.getElementById("in-staff-163").checked)){
				 document.getElementById("branddiv").style.display = "block";
				document.getElementById("jurisdictiondiv").style.display = "block";
				document.getElementById("deliverydiv").style.display = "block";
				document.getElementById("baseprogramdiv").style.display = "block";
