setInterval(function(){ 
    if (typeof document.getElementById("in-staff-235").checked === "undefined"){
		...
		if (document.getElementById("in-staff-235").checked) {
			if ((typeof document.getElementById("in-staff-233").checked != "undefined") && (document.getElementById("in-staff-233").checked)){
				 document.getElementById("branddiv").style.display = "block";
				document.getElementById("jurisdictiondiv").style.display = "block";
				document.getElementById("deliverydiv").style.display = "block";
				document.getElementById("baseprogramdiv").style.display = "block";
			 }
			else if ((typeof document.getElementById("in-staff-237").checked != "undefined") &&(document.getElementById("in-staff-237").checked)){
				 document.getElementById("branddiv").style.display = "block";
				document.getElementById("jurisdictiondiv").style.display = "block";
				document.getElementById("deliverydiv").style.display = "block";
				document.getElementById("baseprogramdiv").style.display = "block";
