	...
	*/
	...
	public function add_non_hierarchical_term(){
		...
		foreach ( $names as $cat_name ) {
			...
			if (intval( $cat_id ) == 0){
				$data = sprintf( '<li id="%1$s-%2$s" style="display:none;"><label class="selectit"><input id="in-%1$s-%2$s" type="radio" name="radio_tax_input[%1$s][]" value="%2$s" checked="checked"> %3$s</label></li>',
