	...
	public static function test( $settings ) {
		...
		if ( true === $sendOK ) {
			...
			if ( '1' == $settings['stash_mode'] ) { // Stash mode.
				...
				$delete_response = pb_backupbuddy_destination_stash2::deleteFile( $settings, 'remote-send-test.php' );
				if ( true === $delete_response ) { // success
				...
				try {
					...
					$error = 'Unable to delete test S3 test file `remote-send-test.php`. Details: `' . $e->getMessage() . '`.';
