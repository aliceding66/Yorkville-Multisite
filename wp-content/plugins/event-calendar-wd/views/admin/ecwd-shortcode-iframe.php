...
if(isset($_GET['edit']) && !empty($_GET['edit']) && $_GET['edit'] != "undefined" ){
  $ecwd_edit_shortcode = str_replace('\"' , '"' ,$_GET['edit']);
...
<div class="ecwd_shortcode">
  <div class="ecwd_shortcode_header">
    <h1>ECWD Shortcode</h1>
  </div>
...
?>
      ...
      <div class="ecwd_shortcode_params">
        ...
        <?php
        if($ecwd_edit_shortcode_data === null || (isset($ecwd_edit_shortcode_data["event_search"]) && $ecwd_edit_shortcode_data["event_search"]==="on")){
          echo '<input name="ecwd_event_search" id="ecwd_event_search" type="checkbox" checked>';
        }else{
          echo '<input name="ecwd_event_search" id="ecwd_event_search" type="checkbox">';
        }
        ?>
      </div>
