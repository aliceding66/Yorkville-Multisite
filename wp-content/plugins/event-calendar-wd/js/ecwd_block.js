(function( blocks, element ) {
    ...
    var ecwd_gutenberg_block = function () {


      registerAllPluginBlocks();

      function registerAllPluginBlocks() {
        var twPluginsData = window['tw_gb_ecwd'];
        if (!twPluginsData) {
          return;
        }
        ...
        blocks.registerBlockType(pluginId, {
          ...
          edit: function (props) {
            ...
            function showPopup(shortcode_id) {
              ...
              var elem = el('form', {className: 'tw-container'}, el('div', {className: "ecwd_tw-container-wrap"}, el('span', {
            ...
            function showShortcodePlaceholder() {
              ...
              }, "You're not select any calendar. Click to choose calendar");
            }
