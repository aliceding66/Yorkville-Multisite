...
class WP_PVP_admin {
	...
	private static function update_setting() {
		...
		update_option('PVP_options', WP_PVP::$options);

		?>
		<div class="notice notice-success is-dismissible">
			<p><strong><?=__('Updated Options Success', WP_PVP::$textdomain) ?></strong></p>
		</div>
		<?php
	}

	private static function reset_setting() {
		update_option('PVP_options', WP_PVP::$default_options);

		?>
		<div class="notice notice-success is-dismissible">
			<p><strong><?=__('Reset Optionsto Default Success', WP_PVP::$textdomain) ?></strong></p>
		</div>
		<?php
	}
