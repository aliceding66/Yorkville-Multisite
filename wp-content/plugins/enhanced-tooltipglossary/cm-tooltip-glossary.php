...
//        }
	...
	private static function _resetOptions() {
		...
		update_option( 'cmtt_glossary_backLinkText', '&laquo; View Encyclopedia' );
		update_option( 'cmtt_glossary_backLinkBottomText', '&laquo; View Encyclopedia' );
